...
namespace BTL_PTTKHT
{
    public partial class frmSuaNV : Form
    {
        ...
        public bool checkData()
        {
            ...
            if (string.IsNullOrEmpty(txtMaNV.Text) || (string.IsNullOrEmpty(txtTenNV.Text)) || (string.IsNullOrEmpty(txtDiaChi.Text)) || (string.IsNullOrEmpty(txtSDT.Text)))
            {
        ...
        private void btnSua_Click(object sender, EventArgs e)
        {
            if (checkData())
            {
                ...
                if (bllNhanVien.UpdateNhanVien(NhanVien))
                {
